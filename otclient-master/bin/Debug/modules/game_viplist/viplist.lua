...
function init()
  ...
  vipWindow = g_ui.loadUI('/game_viplist/viplist', modules.game_interface.getRightPanel())
...
function createAddWindow()
  if not addVipWindow then
    addVipWindow = g_ui.displayUI('/game_viplist/addvip')
  end
end
...
function createEditWindow(widget)
  ...
  editVipWindow = g_ui.displayUI('/game_viplist/editvip')
