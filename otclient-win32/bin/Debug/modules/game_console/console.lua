...
function init()
  ...
  consolePanel = g_ui.loadUI('/game_console/console', modules.game_interface.getBottomPanel())
...
function openPlayerReportRuleViolationWindow()
  ...
  violationWindow = g_ui.loadUI('/game_console/violationwindow', rootWidget)
...
function onChannelList(channelList)
  ...
  channelsWindow = g_ui.displayUI('/game_console/channelswindow')
  local channelListPanel = channelsWindow:getChildById('channelList')
...
function onClickIgnoreButton()
  ...
  communicationWindow = g_ui.displayUI('/game_console/communicationwindow')
