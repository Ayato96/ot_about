local cwd = (...):gsub("%.[^%.]+$", "") .. "."
require(cwd .. "offerstatistic")
require(cwd .. "marketoffer")
require(cwd .. "marketprotocol")
...
local protocol = runinsandbox('/game_market/marketprotocol')
...
local function initInterface()
  ...
  marketOffersPanel = g_ui.loadUI('/game_market/ui/marketoffers')
  ...
  browsePanel = g_ui.loadUI('/game_market/ui/marketoffers/browse')
  selectionTabBar:addTab(tr('Browse'), browsePanel)

  -- Currently not used
  -- "Reserved for more functionality later"
  --overviewPanel = g_ui.loadUI('/game_market/ui/marketoffers/overview')
  ...
  itemStatsPanel = g_ui.loadUI('/game_market/ui/marketoffers/itemstats')
  displaysTabBar:addTab(tr('Statistics'), itemStatsPanel)

  itemDetailsPanel = g_ui.loadUI('/game_market/ui/marketoffers/itemdetails')
  displaysTabBar:addTab(tr('Details'), itemDetailsPanel)

  itemOffersPanel = g_ui.loadUI('/game_market/ui/marketoffers/itemoffers')
  ...
  myOffersPanel = g_ui.loadUI('/game_market/ui/myoffers')
  ...
  currentOffersPanel = g_ui.loadUI('/game_market/ui/myoffers/currentoffers')
  offersTabBar:addTab(tr('Current Offers'), currentOffersPanel)

  offerHistoryPanel = g_ui.loadUI('/game_market/ui/myoffers/offerhistory')
...
function init()
  g_ui.importStyle('/game_market/market')
  g_ui.importStyle('/game_market/ui/general/markettabs')
  g_ui.importStyle('/game_market/ui/general/marketbuttons')
  g_ui.importStyle('/game_market/ui/general/marketcombobox')
  g_ui.importStyle('/game_market/ui/general/amountwindow')
