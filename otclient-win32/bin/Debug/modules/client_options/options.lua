...
function init()
  ...
  optionsWindow = g_ui.displayUI('/client_options/options')
  optionsWindow:hide()
  ...
  generalPanel = g_ui.loadUI('/client_options/game')
  optionsTabBar:addTab(tr('Game'), generalPanel, '/images/optionstab/game')

  consolePanel = g_ui.loadUI('/client_options/console')
  optionsTabBar:addTab(tr('Console'), consolePanel, '/images/optionstab/console')

  graphicsPanel = g_ui.loadUI('/client_options/graphics')
  optionsTabBar:addTab(tr('Graphics'), graphicsPanel, '/images/optionstab/graphics')

  audioPanel = g_ui.loadUI('/client_options/audio')
