...
function init()
  ...
  monsterMakerWindow = g_ui.displayUI('/mods/tool_monstermaker/tool_monstermaker')
  ...
  monsterPanel = g_ui.loadUI('/mods/tool_monstermaker/monster')
  flagsPanel = g_ui.loadUI('/mods/tool_monstermaker/flags')
  scriptPanel = g_ui.loadUI('/mods/tool_monstermaker/script')
  attacksPanel = g_ui.loadUI('/mods/tool_monstermaker/attacks')
  defensesPanel = g_ui.loadUI('/mods/tool_monstermaker/defenses')
  elementsPanel = g_ui.loadUI('/mods/tool_monstermaker/elements')
  immunitiesPanel = g_ui.loadUI('/mods/tool_monstermaker/immunities')
  summonsPanel = g_ui.loadUI('/mods/tool_monstermaker/summons')
  voicesPanel = g_ui.loadUI('/mods/tool_monstermaker/voices')
  lootPanel = g_ui.loadUI('/mods/tool_monstermaker/loot')
  ioPanel = g_ui.loadUI('/mods/tool_monstermaker/io')
